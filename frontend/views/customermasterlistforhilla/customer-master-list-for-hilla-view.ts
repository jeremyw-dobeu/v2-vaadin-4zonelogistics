...
import SamplePerson from 'Frontend/generated/zonelogistics/data/entity/SamplePerson';
import SamplePersonModel from 'Frontend/generated/zonelogistics/data/entity/SamplePersonModel';
import { html } from 'lit';
import { customElement, property, query } from 'lit/decorators.js';
import { View } from '../view.js';

@customElement('customer-master-list-for-hilla-view')
export class CustomerMasterListForHillaView extends View {
  @query('#grid')
  private grid!: Grid;
